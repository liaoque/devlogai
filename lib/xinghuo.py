...
def send(config, query):
    appid = config['global']['xinghuo.appid']
    api_secret = config['global']['xinghuo.api_secret']
    api_key = config['global']['xinghuo.api_key']
    gpt_url = config['global']['xinghuo.gpt_url']
    domain = config['global']['xinghuo.domain']
